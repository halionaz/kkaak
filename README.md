...
🇰🇷 **한국 시간 기반**: 한국에서 미국 증시를 트레이딩하는 투자자를 위해 KST 기준으로 동작합니다.
📖 **[한국 시간 가이드 보기](KOREA_TIME_GUIDE.md)** - 실행 시간표, 서머타임 안내, 실생활 가이드
...
- 🔔 **장전 리포트**: 매일 밤 overnight 뉴스 종합 분석 + 20개 종목 시그널
  - **한국 시간: 23:00 KST (표준시) / 22:00 KST (서머타임)**
  - 미국 시간: 09:00 ET (장 시작 30분 전)
- 🚨 **실시간 시그널 업데이트**: 30분 간격으로 뉴스 & 가격 변동 모니터링, 보수적 시그널 업데이트
  - **한국 시간: 23:30 - 06:00 KST (표준시) / 22:30 - 05:00 KST (서머타임)**
  - 미국 시간: 09:30 - 16:00 ET (정규 장 시간)
- 📊 **보수적 필터링**:
  - 신뢰도 70% 미만 자동 HOLD
...
- 🌏 **한국 시간 기반**: 한국에서 미국 증시 트레이딩하기 최적화, 서머타임 자동 반영
...
### 장전 리포트 (23:00 KST / 09:00 ET)
```
🔔 [PREMARKET REPORT] 2026-02-12 23:00 KST
...
### Pre-Market Analysis (23:00 KST / 09:00 ET)
...
**실행 시간:**
- 표준시(11월-3월): 23:00 KST
- 서머타임(3월-11월): 22:00 KST
- *자동으로 서머타임 반영*

### Realtime Analysis (30분 간격, 23:30-06:00 KST / 09:30-16:00 ET)
...
**실행 시간:**
- 표준시(11월-3월): 23:30 - 06:00 KST (다음날 새벽)
- 서머타임(3월-11월): 22:30 - 05:00 KST (다음날 새벽)
- *30분 간격 자동 실행*

### 🌏 서머타임 자동 처리
- 미국 서머타임: 3월 둘째 일요일 ~ 11월 첫째 일요일
- 시스템이 자동으로 ET/KST 변환하여 정확한 시간에 실행
- 사용자가 별도 설정 변경할 필요 없음
